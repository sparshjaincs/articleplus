    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.TimeField(default=datetime.datetime(2020, 7, 11, 21, 12, 57, 604835))),
                ...
                ('category', models.ForeignKey(default=' ', on_delete=django.db.models.deletion.CASCADE, related_name='category1', to='stories.Categories', to_field='category_name')),
                ('disliked', models.ManyToManyField(blank=True, default=None, related_name='dislikes_stories', to=settings.AUTH_USER_MODEL)),
                ('liked', models.ManyToManyField(blank=True, default=None, related_name='likes_stories', to=settings.AUTH_USER_MODEL)),
                ('user_stories', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user1', to=settings.AUTH_USER_MODEL, to_field='username')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='stories.Story_comment')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Story_comments', to='stories.Stories')),
            ],
            options={
                'ordering': ('-created',),
            },
